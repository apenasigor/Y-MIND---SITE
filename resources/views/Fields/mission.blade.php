...
<head>
    ...
    <meta property="og:title" content="Mission - Y-Mind">
...
<div class="page-container">
    <div class="identity-stripe" role="banner" style=" cursor: url({{asset('/images/cursor-do-centro-de-neuromodulaão-04_1.cur')}}),auto; ">
        <div class="center force">
            <a class="logo-tab column" href="{{url('/')}}" title="Home" style="padding: 0 0 10px 0; ">
                <img src="{{asset('/images/neuroservices/y-mind-logo.png')}}" alt="we mind - neuro services" >
            </a>
        </div>
    </div>
    ...
    <div class="page-title-section">
        @yield('hero-image','<div class="page-title-background" style="background-image:url('. asset('/images/neuroservices/mission.png') .')">')
        </div>
        <div class="dot-matrix"></div>
        <div class="center">
            <div class="page-title-container">
                <h1 class="page-title">
                    <span style="white-space: nowrap;">Mission</span>
                    </h1>
                <!--googleoff: all-->
                <h4 class="page-breadcrumb"> <span style="white-space: nowrap;"><a href="{{url('/')}}" title="Home">Home</a></span>
                    <span aria-hidden="true">&gt;</span>
                    <span style="white-space: nowrap;"><a href="{{url('/mission')}}" title="Neuromodulação">Mission</a></span>
                </h4>
                <!--googleon: all-->
            </div>
        </div>
        ...
        <div class="center force">
            ...
            <div class="primary-column column force">
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        <li class="parent-level"> <a href="{{url('/about-us')}}" title="About US" class="destination">About US</a>
                            <ul class="tier-2">
                                <li class=""> <a href="{{url('/about-us')}}" title="University Leadership" class="destination">Parágrafo 1</a>
                                    <ul class="tier-3">
                                        <li class=""> <a href="{{url('/about-us')}}" title="Office of the President" class="destination">Ponto 1</a> </li>
                                        <li class=""> <a href="{{url('/about-us')}}" title="Office of the Provost" class="destination">Ponto 2</a> </li>
                                    </ul>
                                </li>
                        ...
                        <li class="active-page active-section open parent-level"> <a href="{{url('/mission')}}" title="Mission" class="destination">Mission</a>
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Mission</span></strong></h2>
                        <p style="line-height: 1.5em">

                            To prevent young minds from developing mental disorders and mental disease progression by providing the best care, research, population awareness and public policies.

                            Vision
                            Become one of the most important centres for prevention of mental disorders in the world influencing mental health policies in Brazil


                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Values</span></strong></h2>

                           EMPATHY – we care for people.<br>
                           TEAMWORK – we value a diversity of opinions and synergy of actions.<br>
                           COMMITMENT – we enjoy what we do and work hard to progress.<br>
                           CREATIVITY – we are focused in the developing novel strategies.<br>
                           INNOVATION – we believe in progress and lead by example.<br>

                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;"> Strategy</span></strong></h2>

                            Y-Mind congregates several initiatives developed at the UNIFESP (see Programas) <br><br>and expand their actions into the society. Y-Mind was developed using a
                            very successful model of public (UNIFESP) and third sector partnerships (Foundations/NGOs) such as paediatric cancer (GRAAC) and sleep disorders
                            (Instituto do Sono – one of the largest in the world). <br><br>The partnership promotes a fruitful synergy, which includes exchange of professionals
                            (professors, doctors and mental health professionals), clinical assistance <br>(for patients from UNIFESP), developing cutting edged research, and
                            obtaining grant and donations from the private sector.<br>



                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Actions</span></strong></h2>


                           Scale-up the ‘model of care for young people at risk for mental disorders’<br>
                           Train human resources to intervene with young people<br>
                           Increase rates of employment of people with mental disorders<br>
                           Expand the teacher’s training program for 10 states of Brazil<br>
                           New Clinical-Research Building<br>
                           Influence policy makers to focus in young people mental health<br>
