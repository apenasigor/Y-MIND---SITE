                ...
                <h4 class="page-breadcrumb">
                    ...
                    <span style="white-space: nowrap;">
                        <a href="{{url('/programs')}}" title="Programs">Programs</a>
                         <span aria-hidden="true">&gt;</span>
                        <a href="{{url('/programs/Proesq')}}" title="Proesq">Proesq</a>
                    </span> </h4>
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        ...
                        <li class="active-section open parent-level">
                            ...
                            <ul class="tier-2">
                                <li class=""><a href="{{url('/programs/Linc')}}" title="LiNC" class="destination">LiNC</a></li>
                                <li class="active-page active-section open parent-level"><a href="{{url('/programs/Proesq')}}" title="PROESQ " class="destination">PROESQ </a></li>
                                <li class=""><a href="{{url('/programs/Prisma')}}" title="PRISMA " class="destination">PRISMA </a></li>
                                <li class=""><a href="{{url('/programs/Papia')}}" title="PAPIA " class="destination">PAPIA </a></li>
                                <li class=""><a href="{{url('/programs/Inserir')}}" title="INSERIR " class="destination">INSERIR </a></li>
                                <li class=""><a href="{{url('/programs/Teamm')}}" title="TEAMM " class="destination">TEAMM </a></li>
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        ...
                        <p style="line-height: 1.5em">
                            ...
                            schizophrenia and families, develop state of the art research and treatment technology,
                            and train professionals to provide best care all over Brazil. Have trained more than 300
                            psychiatry residents and mental health professionals (3% of Psychiatrists in Brazil) and
                            treatment of more than 1,000 patients and families. First-Episode Psychosis Unit -
                            Established in 2009; Largest Research Program in First-Episode in Latin America

                        <div class="image">

                            <img style="width:100%" src="{{asset('/images/neuroservices/team/proesq.jpg')}}" alt="PROESQ">
                        </div>
