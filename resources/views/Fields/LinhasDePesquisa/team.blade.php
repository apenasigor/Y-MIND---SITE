...
<head>
    ...
    <meta property="og:title" content="Y-Mind - Team">
...
<div class="page-container">
    ...
    <div class="page-title-section">
        <div class="page-title-background" style="background-image:url('{{asset('/images/neuroservices/research.png')}}')"></div>
        <div class="dot-matrix"></div>
        <div class="center">
            <div class="page-title-container">
                <h1 class="page-title"> <span style="white-space: nowrap;">Team</span> </h1>
                <!--googleoff: all-->
                <h4 class="page-breadcrumb">
                    ...
                    <span style="white-space: nowrap;">
                        <a href="{{url('/team')}}" title="Team">Team</a>
                    </span> </h4>
                <!--googleon: all-->
            </div>
        </div>
            ...
            <div class="primary-column column force">
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        ...
                        <li class="active-page active-section open parent-level"> <a href="{{url('/team')}}" title="Team" class="destination">Team</a>
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Team</span></strong></h2>
                        <p style="line-height: 1.5em">
                            ...
                            <div class="ajustegraphics">
                                ...
                                <div class="graphics">
                                    <img src="{{asset('/images/neuroservices/team/team01.png')}}" alt="Jair de Jesus Mari">

                                    <div class="textEdit">
                                        <p class="Teamtitle">Rodrigo Affonseca Bressan
                                            <br>Head & Molecular Imaging<br></p>
                                    </div>
                                </div>
                                </div>
                                <div class="supporting-content-item teaser type-teaser force has-image js-transform" data-id="20521" data-type="teaser">
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team02.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">Dr. Jair de Jesus Mari<br>Psychiatrist<br><br></p>
                                        </div>
                                    </div>
                                ...
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team03.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">Andrea Parolin Jackowski
                                                <br>Neuroimaging Structural and<br> Functional<br></p>
                                        </div>
                                    </div>
                                ...
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team04.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">
                                                Álvaro Machado Dias<br>
                                                Neuropsychology<br>
                                                Teacher, PhD<br></p>
                                        </div>
                                    </div>
                                ...
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team05.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">Acioly Luiz Tavares de Lacerda<br>Neuropsychology<br>
                                                Teacher, PhD<br></p>
                                        </div>
                                    </div>
                                ...
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team06.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">
                                                Síntia Iole Belangero<br>
                                                Genetics<br>
                                                Teacher, PhD<br></p>
                                        </div>
                                    </div>
                                ...
                                <div class="ajustegraphics">
                                    <div class="graphics">
                                        <img src="{{asset('/images/neuroservices/team/team07.png')}}" alt="Jair de Jesus Mari">

                                        <div class="textEdit">
                                            <p class="Teamtitle">Ary Gadelha
                                                <br>Integrative Neuroscience<br><br></p>
                                        </div>
                                    </div>
