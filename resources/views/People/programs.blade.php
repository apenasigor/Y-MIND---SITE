...
<head>
    ...
    <title>Y-Mind - Programs</title>
    <meta name="description" content="Y-Mind ">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="referrer" content="origin">


    <meta property="og:site_name" content="Y-Mind - Programs">
    <meta property="og:title" content="Y-Mind - Programs">
    <meta property="og:url" content="{{url('/')}}">
    <meta property="og:description" content="Y-Mind ">
    ...
    <style>
        ...
        .page-layout_inner .big-story-container:hover {
            background-color: #76bce6 !important;
        }
...
<div class="page-container">
    ...
    <div class="identity-stripe" role="banner">
        <div class="center force">
            <a class="logo-tab column" href="{{url('/')}}" title="Home">
                <img src="{{asset('/images/neuroservices/y-mind-logo.png')}}" alt="Centro de Neuromodulação">
            </a>
        </div>
    </div>
    ...
    <div class="page-title-section">
        <div class="page-title-background" style="background-image:url('{{asset('/images/neuroservices/program.png')}}')"></div>
        <div class="dot-matrix"></div>
        <div class="center">
            <div class="page-title-container">
                <h1 class="page-title"> <span style="white-space: nowrap;">Programs</span> </h1>
                <!--googleoff: all-->
                <h4 class="page-breadcrumb">
                    ...
                    <span style="white-space: nowrap;">
                        <a href="{{url('/programs')}}" title="Programs">Programs</a>
                    </span> </h4>
                <!--googleon: all-->
            </div>
        </div>
            ...
            <div class="primary-column column force">
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        <li class="parent-level">
                            ...
                            <ul class="tier-2">
                                <li class="">
                                    <a href="{{url('/about-us')}}" title="University Leadership" class="destination">Parágrafo 1</a>
                                    <ul class="tier-3">
                                        <li class="">
                                            <a href="{{url('/about-us')}}" title="Office of the President" class="destination">Ponto 1</a>
                                        </li>
                                        <li class="">
                                            <a href="{{url('/about-us')}}" title="Office of the Provost" class="destination">Ponto 2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class=""> <a href="{{url('/about-us')}}" title="History &amp; Mission" class="destination">Parágrafo 2</a>
                                    <ul class="tier-3">
                                        <li class=""> <a href="{{url('/about-us')}}" title="Gilman's Inaugural Address" class="destination">Ponto 1</a> </li>
                                    </ul>
                                </li>
                                <li class=""> <a href="{{url('/about-us')}}" title="Notable Alumni" class="destination">Parágrafo 3</a> </li>
                            </ul>
                        </li>
                        <li class="parent-level"> <a href="{{url('/mission')}}" title="Mission" class="destination">Mission</a>
                        ...
                        <li class="parent-level"> <a href="{{url('/researchers')}}" title="Researchers" class="destination">Researchers</a>
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        <div class="image">
                            <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Programs</span></strong></h2>
                                <img style="width: 100%;" src="{{asset('/images/neuroservices/team/programs.png')}}" alt="TNS - Transcutaneous electrical nerve stimulation">
                        </div>
                        <!--
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Programs</span></strong></h2>

                        <p style="line-height: 1.5em">
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">LiNC</span></strong></h2>
                             Interdisciplinary Clinical Neuroscience Lab established in 2004, focused in integrative
                            neuroscience of neurodevelopmental disorders.<br> The lab has a translation approach to mental
                            disorders using neuroscience methodologies, such as functional and structural neuroimaging (MRI)<br>
                            to evaluate brain connectivity, genetics and epigenetics (DNA, RNA), inflamatory and imune
                            biomarkers, neuropsychology, psychopathology, and animal models.<br><br>
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">PROESQ </span></strong></h2>
                            Established in 1995. The most important outpatient program to treat people with
                            schizophrenia and families, develop state of the art research and treatment technology, and train
                            professionals to provide best care all over Brazil. Have trained more than 300 psychiatry residents
                            and mental health professionals (3% of Psychiatrists in Brazil) and treatment of more than
                            1,000 patients and families.

                            First-Episode Psychosis Unit - Established in 2009; Largest Research Program in First-Episode
                            in Latin America
                            <br>
                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">PRISMA </span></strong></h2>Established in 2008. 1st Outpatient Clinic Focused on At-Risk Subjects for Schizophrenia
                            <br>
                            PAPIA - Established in 2008. 1st Outpatient Clinic in Brazil Focused on Childhood-Onset Schizophrenia
                            <br>
                            INSERIR - Established in 2010. Project focused on Work Recovery for People With Schizophrenia and severe mental disorders.
                            <br>
                            TEAMM - SOCIAL COGNITION TEAM (autism) - 100 patients; 100 assessments/month; 50 volunteers.<br>
                            Focused inearly diagnosis and prevention of autism progression through state of the art parents
                            and children interventions.<br><br>


                            CUCA LEGAL (colocar link para o site) - School Mental Health program established in 2007




                        <h2><strong><span style="line-height: 1.5em; color: #76bce6;">Past Actions</span></strong></h2>
                         Scientific production – more than 200 articles published in international scientific journals
                         Several National and International Awards in Mental Disorders Research<br><br>

                         Partnership with Politics in the development of policies regarding mental health
                         Several actions together with Deputada Federal Mara Gabrilli ()
                         Law – Quota for People Schizophrenia and severe mental disorders (Lei Brasileira de Inclusão)<br><br>
                ...
                <div class="nav column force">
                    ...
                    <ul class="site-tree column tier-1">
                        ...
                        <li class="parent-level"> <a href='#' class='toggle-section' title='Expand Academics section'>
                                ...
                                <span class='icon-fallback'>+</span>
                                <span class='visuallyhidden'>Expandir o menu</span></a>
                            <a href="{{url('/researchers')}}" title="Researchers" class="destination">Researchers</a>
                        </li>
                    </ul>
                </div>
